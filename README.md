...
Year-over-year analysis and strategic recommendations.

![Trends & Summary Page](Images/trends_summary.png)

**Features:**
- KPI cards showing absolute change (+28,912 students) and growth rate (+0.7%)
- Horizontal bar chart comparing enrollment change by affiliation
- Enrollment comparison matrix (2024 vs 2025)
- Key findings and recommendations text box

**Key Insights:**
- **Independent Schools:** Strongest growth +23,551 (+3.4%) 📈
- **Government Schools:** Slight decline -6,109 (-0.2%) 📉
- **Catholic Schools:** Recovery trend +11,470 (+1.4%) 📈
- **Market Stability:** Overall modest growth suggests stabilizing patterns
